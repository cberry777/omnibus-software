...
build do
   ...
   command "git clone https://#{github_token}:x-oauth-basic@github.com/DataDog/go-metro.git", :env => env, :cwd => "/var/cache/omnibus/src/datadog-metro/src/github.com/DataDog"
   ...
   patch :source => "libpcap-static-link.patch", :plevel => 1, :target => "/var/cache/omnibus/src/datadog-metro/src/github.com/google/gopacket/pcap/pcap.go"
